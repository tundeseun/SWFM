...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      mouseenter: _vm.showProductSubmenu,
      mouseleave: _vm.hideProductSubmenu
    }
  }, [_c("a", {
    ...
    staticClass: "sidebar-submenu ps rtl-ps-none",
    "class": {
      open: _vm.getSideBarToggleProperties.isSecondarySideNavOpen
    },
    staticStyle: {
    ...
    ref: "sidebarmenuNav",
    staticClass: "submenusNav d-none",
    "class": {
      "d-block": _vm.selectedParentMenu == "warehouse_products"
    },
    attrs: {
      "data-parent": "warehouse_products"
    }
  }, [_c("li", {
    staticClass: "nav-item"
  }, [_c("router-link", {
    ...
    staticClass: "item-name"
  }, [_vm._v("Count Stock")])])], 1), _vm._v(" "), _c("li", {
    staticClass: "nav-item"
  }, [_c("router-link", {
    attrs: {
      tag: "a",
