...
var sidebarmenuNav = (0,vue__WEBPACK_IMPORTED_MODULE_2__.ref)(null);
var selectedParentMenu = (0,vue__WEBPACK_IMPORTED_MODULE_2__.ref)('');
var productSubmenuVisible = (0,vue__WEBPACK_IMPORTED_MODULE_2__.ref)(false);
function showProductSubmenu() {
  productSubmenuVisible.value = true;
}
function hideProductSubmenu() {
  setTimeout(function () {
    productSubmenuVisible.value = false;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      selectedParentMenu: "",
      hoveredItem: null,
      // Add this state to track hovered item
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_3__.mapGetters)(["getSideBarToggleProperties", "currentUserPermissions", "getallmodules"])),
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_3__.mapActions)(["changeSecondarySidebarProperties", "changeSecondarySidebarPropertiesViaMenuItem", "changeSecondarySidebarPropertiesViaOverlay", "changeSidebarProperties"])), {}, {
