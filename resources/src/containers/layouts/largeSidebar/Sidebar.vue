    ...
    >
      <div ref="sidebarChild">
        ...
        <ul
          ...
          :class="{ 'd-block': selectedParentMenu == 'warehouse' }"
        >
...
<li 
@mouseenter="toggleSubMenu"
  :class="{ active: selectedParentMenu == 'warehouse_products' }"
...
<li 
@mouseenter="toggleSubMenu"
  :class="{ active: selectedParentMenu == 'warehouse_inventory' }"
  data-item="warehouse_inventory"
  :data-submenu="true"
class="nav-item">
  <router-link tag="a" class="nav-link" to="/app/inventory">
...
<!-- Shelves -->
<li class="nav-item">
  <router-link tag="a" class="nav-link" to="/app/shelves">
    <i class="nav-icon i-Library"></i>
    <span class="item-name">Shelves</span>
  </router-link>
</li>

<!-- Orders -->
<li class="nav-item">
  <router-link tag="a" class="nav-link" to="/app/orders">
    <i class="nav-icon i-File-ClipboardFileText"></i>
...
<!-- Pallet -->
<li class="nav-item">
  <router-link tag="a" class="nav-link" to="/app/pallet">
    <i class="nav-icon i-Ship-2"></i>
    <span class="item-name">Pallet</span>
  </router-link>
</li>

<!-- Alert -->
<li class="nav-item">
  <router-link tag="a" class="nav-link" to="/app/alert">
    <i class="nav-icon i-Error-404Window"></i>
...
>
  ...
  <li class="nav-item">
    <router-link tag="a" class to="/app/warehouse/products/list">
      <i class="nav-icon i-Files"></i>
      <span class="item-name">Product List</span>
    </router-link>
  </li>
  <li class="nav-item">
    <router-link tag="a" class to="/app/warehouse/products/categories">
      <i class="nav-icon i-Duplicate-Layer"></i>
      <span class="item-name">Print Labels</span>
    </router-link>
  </li>
  <li
   class="nav-item">
    <router-link tag="a" class to="/app/warehouse/products/brands">
      <i class="nav-icon i-Bookmark"></i>
  ...
  :class="{ 'd-block': selectedParentMenu == 'warehouse_inventory' }"
>
  <li class="nav-item">
    <router-link tag="a" class to="/app/warehouse/products/add">
      <i class="nav-icon i-Add-File"></i>
      <span class="item-name">All Inventory</span>
    </router-link>
  </li>
